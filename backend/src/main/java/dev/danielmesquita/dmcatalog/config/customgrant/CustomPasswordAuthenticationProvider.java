...
public class CustomPasswordAuthenticationProvider implements AuthenticationProvider {
  ...
  public Authentication authenticate(Authentication authentication) throws AuthenticationException {
    ...
    Set<String> authorizedScopes = user.getAuthorities().stream()
            ...
            .filter(scope -> registeredClient != null && registeredClient.getScopes().contains(scope))
    ...
    OAuth2Authorization.Builder authorizationBuilder = null;
    ...
    return new OAuth2AccessTokenAuthenticationToken(Objects.requireNonNull(registeredClient), clientPrincipal, accessToken);
  }
